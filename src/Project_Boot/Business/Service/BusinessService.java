package com.project.Project_Boot.Business.Service;
...
public class BusinessService {
    ...
    public String addService(List<Product> product){
        Authentication auth = SecurityContextHolder.getContext().getAuthentication();
        Business business = businessRepository.findBusinessByUserId(auth.getName());
        if(business == null){
            return null;
...
//        return product;
        ...
        for(int i = 0; i < product.size(); i++){
            product.get(i).setBusinessId(business.getUserId());
        }
    ...
    public Product updateService(ProductDTO product) {
        ...
        serviceInfo.setImageUrl(product.getImageUrl());
    ...
    public List<Product> allServicesOfBusiness(){
        Authentication auth = SecurityContextHolder.getContext().getAuthentication();
        return productRepository.findProductsByBusinessId(auth.getName());
    }
